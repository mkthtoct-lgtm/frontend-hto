    ...
    return (
        ...
        <div className="app-header-inner">
          <div className="app-header-start">
            ...
            <form className="d-none d-xl-flex align-items-center h-100 w-lg-250px w-xxl-300px position-relative" action="#">
              <input type="text" className="form-control px-sm-3 bg-light" placeholder="Search anything" />
              <button type="button" className="btn btn-sm text-primary border-0 position-absolute end-0 me-3 p-0">
          ...
          <div className="app-header-end">
            <div className="d-flex align-items-center gap-sm-1 gap-0 px-lg-2 px-sm-2 px-1">
              <div className="dropdown text-end">
                <a href="#" className="btn btn-icon btn-action-gray" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="true">
                ...
                <div className="dropdown-menu dropdown-menu-lg-end p-0 w-300px mt-2">
                  <div className="px-3 py-3 border-bottom d-flex justify-content-between align-items-center">
                    <h6 className="mb-0">Notifications <span className="badge badge-sm rounded-pill bg-primary ms-1">9</span>
                    </h6>
                  ...
                  <div className="p-2">
                    <a href="#" className="btn w-100 btn-primary">View all notifications</a>
                  </div>
                </div>
              </div>
              <a href="email/inbox.html" className="btn btn-md btn-icon btn-action-gray">
                <i className="icon-message-square-text"></i>
                <span className="visually-hidden">Inbox</span>
              </a>
              <a href="calendar.html" className="btn btn-md btn-icon btn-action-gray d-none d-sm-flex">
                <i className="icon-calendar"></i>
                <span className="visually-hidden">Calendar</span>
              </a>
              <a href="#" className="btn btn-md btn-icon btn-action-gray theme-btn">
                ...
                <ul className="dropdown-menu dropdown-menu-end w-225px mt-1">
                  <li className="d-flex align-items-center p-2">
                    ...
                    <div className="ms-2">
                      ...
                      <small className="text-body d-block lh-sm">john@gamil.com</small>
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    <a className="dropdown-item d-flex align-items-center gap-2" href="profile.html">
                      <i className="fi fi-rr-user scale-1x"></i> View Profile
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item d-flex align-items-center gap-2" href="pages/faq.html">
                  ...
                  <li>
                    <a className="dropdown-item d-flex align-items-center gap-2" href="pages/pricing.html">
                  ...
                  <li>
                    <a className="dropdown-item d-flex align-items-center gap-2 text-danger" href="authentication/login.html">
