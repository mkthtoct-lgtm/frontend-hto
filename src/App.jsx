...
function App() {
  ...
  return (
    <div className="page-layout bg-body-tertiary">
        ...
        {currentPage === "documents" ? (
          ...
          <div className="container-fluid pt-3 pb-1" style={{ maxWidth: "1600px" }}>
            ...
            <div className="row mb-3 gx-2 gx-xl-3 align-items-stretch">
              <div className="col-8 col-md-8 col-lg-8 col-xl-8 mb-0">
              ...
              <div className="col-12 col-md-3 col-lg-3 col-xl-3 mb-3 mb-md-0">
                <div className="card border-0 h-100" style={{ borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", minHeight: "240px" }}>
                  <div className="card-body p-2 p-xl-3 d-flex flex-column justify-content-between">
                    ...
                    <div className="d-flex justify-content-between mb-2 gap-1 gap-xl-2">
                      <div className="text-center rounded p-1 p-xl-2 flex-fill bg-primary-subtle text-primary">
                      ...
                      <div className="text-center rounded p-1 p-xl-2 flex-fill bg-warning-subtle text-warning">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mb-1">
                      ...
                      <div className="text-center rounded p-1 p-xl-2 flex-fill bg-body-secondary text-primary">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mb-1">
                    ...
                    <div className="d-grid gap-1 gap-xl-2" style={{ gridTemplateColumns: "1fr 1fr" }}>
                      <div className="text-white rounded p-1 px-xl-2 py-xl-2 d-flex justify-content-center align-items-center text-nowrap" style={{ backgroundColor: "#5b6cf9", fontSize: "11.5px" }}>
                      ...
                      <div className="text-white rounded p-1 px-xl-2 py-xl-2 d-flex justify-content-center align-items-center text-nowrap" style={{ backgroundColor: "#10b981", fontSize: "11.5px" }}>
                      ...
                      <div className="text-white rounded p-1 px-xl-2 py-xl-2 d-flex justify-content-center align-items-center text-nowrap" style={{ backgroundColor: "#5b6cf9", fontSize: "11.5px", opacity: 0.9 }}>
                      ...
                      <div className="text-white rounded p-1 px-xl-2 py-xl-2 d-flex justify-content-center align-items-center text-nowrap" style={{ backgroundColor: "#10b981", fontSize: "11.5px", opacity: 0.9 }}>
                ...
                <div className="card border-0 h-100" style={{ borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", minHeight: "240px" }}>
                  <div className="card-body p-2 p-xl-3 d-flex flex-column overflow-hidden">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <span className="text-body-secondary d-none d-md-inline" style={{ fontSize: "11px" }}>Cập nhật: 15/03/2026</span>
                    </div>

                    <div className="d-flex justify-content-between align-items-start mt-auto mb-auto overflow-x-auto" style={{ minWidth: "100%" }}>
                      <div className="d-flex justify-content-between w-100" style={{ minWidth: "400px" }}>
                        {[
                          ...
                          { 
                            step: 2, 
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm-2 14l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>, 
                            title: "Đào tạo\nngôn ngữ", sub: "25 min.\n(03 tuần)" 
                          },
                          { 
                            step: 3, 
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6 10H6v-2h8v2zm4-4H6v-2h12v2z"/></svg>, 
                            title: "Nộp hồ sơ\ntrường", sub: "33 min.\n(3h nhận bot)" 
                          },
                          { 
                            step: 4, 
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>, 
                            title: "Xin Visa", sub: "" 
                          },
                          { 
                            step: 5, 
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M2.5 19h19v2h-19zm19.57-9.36c-.21-.8-1.04-1.28-1.84-1.06L14.92 10l-6.9-6.43-1.93.51 4.14 7.17-4.97 1.33-1.97-1.54-1.45.39 1.82 3.16.77 1.33 1.6-.43 5.31-1.42 4.35-1.16L21 11.49c.81-.23 1.28-1.05 1.07-1.85z"/></svg>, 
                            title: "Bay &\nNhập học", sub: "90 min.\n(3h nhận tỉnh)" 
                          },
                          { 
                            step: 6, 
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z"/></svg>, 
                            title: "Đến nơi", sub: "" 
                          }
                        ].map((item, index) => (
                          <div key={index} className="d-flex flex-column align-items-center position-relative" style={{ flex: 1 }}>
                            ...
                            <div className="fw-bold text-center text-body-emphasis mt-1" style={{ fontSize: "12.5px", lineHeight: "1.2", whiteSpace: "pre-line" }}>{item.title}</div>
                            <div className="text-body-secondary text-center mt-1" style={{ fontSize: "10.5px", lineHeight: "1.2", whiteSpace: "pre-line" }}>{item.sub}</div>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            <div className="row mb-3 gx-2 gx-xl-3 align-items-stretch">
              ...
              <div className="col-12 col-md-4 col-lg-4 col-xl-4 mb-3 mb-md-0">
                <div className="card border-0 h-100" style={{ borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", minHeight: "320px" }}>
                  <div className="card-header bg-transparent border-0 p-2 p-xl-3 pb-0">
                    <h6 className="fw-bold d-flex align-items-center mb-0 text-body-emphasis" style={{ fontSize: "14px" }}>
                  ...
                  <div className="card-body p-0 mt-2 d-flex flex-column justify-content-center">
                    <table className="table table-borderless align-middle mb-0" style={{ fontSize: "13px" }}>
                      <thead className="border-bottom">
                        <tr>
                          <th className="fw-bold text-body-emphasis ps-3 py-2" style={{ width: "45%" }}>Hạng mục phí</th>
                          <th className="fw-bold text-body-emphasis text-end py-2 pe-3">Số tiền (VNĐ)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="ps-3 py-2 text-body-secondary fw-medium">Phí dịch vụ HTO</td>
                          <td className="text-end fw-bold py-2 pe-3 text-success" style={{ fontSize: "13px" }}>5.000.000</td>
                        </tr>
                        <tr>
                          <td className="ps-3 py-2 text-body-secondary fw-medium">Học phí</td>
                          <td className="text-end fw-bold py-2 pe-3 text-success" style={{ fontSize: "13px" }}>4.000.000</td>
                        </tr>
                        <tr>
                          <td className="ps-3 py-2 text-body-secondary fw-medium">Sinh hoạt phí dự kiến</td>
                          <td className="text-end fw-bold py-2 pe-3 text-success" style={{ fontSize: "13px" }}>2.000.000</td>
                        </tr>
                        <tr>
                          <td className="ps-3 py-2 text-body-secondary fw-medium">Bảo hiểm</td>
                          <td className="text-end fw-bold py-2 pe-3 text-success" style={{ fontSize: "13px" }}>1.200.000</td>
                        </tr>
                        <tr>
                          <td className="ps-3 py-2 border-bottom text-body-secondary fw-medium">Vé máy bay</td>
                          <td className="text-end fw-bold py-2 border-bottom pe-3 text-success" style={{ fontSize: "13px" }}>350.000</td>
                        </tr>
                        <tr className="bg-body-secondary">
                          <td className="ps-3 py-3 fw-bold text-body-emphasis">Tổng chi phí</td>
                          <td className="text-end fw-bold py-3 pe-3 text-danger" style={{ fontSize: "15px" }}>38.900.000</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div className="col-12 col-md-4 col-lg-4 col-xl-4">
                <div className="card border-0 h-100" style={{ borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", minHeight: "320px" }}>
                  <div className="card-header bg-transparent border-0 p-2 p-xl-3 pb-0 d-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center">
                    <h6 className="fw-bold d-flex align-items-center mb-2 mb-xl-0 text-body-emphasis" style={{ fontSize: "14px" }}>
                      <svg width="20" height="20" viewBox="0 0 24 24" className="text-primary me-2" fill="currentColor">
                    ...
                    <div className="position-relative w-100 w-xl-auto">
                      <input type="text" className="form-control form-control-sm border bg-body-tertiary text-body w-100" placeholder="Tìm câu hỏi..." style={{ fontSize: "11px", paddingRight: "25px", borderRadius: "6px", padding: "4px 8px" }} />
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="position-absolute text-body-secondary" style={{ top: "50%", transform: "translateY(-50%)", right: "8px" }}>
                  ...
                  <div className="card-body p-2 p-xl-3 d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <div className="d-flex mb-2 align-items-start">
                        <div className="rounded-circle text-white d-flex justify-content-center align-items-center me-2 flex-shrink-0" style={{ width: "20px", height: "20px", backgroundColor: "#1d4ed8", fontSize: "11px", fontWeight: "bold", marginTop: "2px" }}>1</div>
                        <div className="flex-grow-1 pe-1">
                          <h6 className="fw-bold mb-1 text-body-emphasis" style={{ fontSize: "13px" }}>Có được làm thêm không?</h6>
                          <p className="text-body-secondary mb-0 text-truncate" style={{ fontSize: "11.5px", lineHeight: "1.3", maxWidth: "180px" }}>Có. Sinh viên được phép làm thêm tối đa...</p>
                        </div>
                      ...
                      <div className="d-flex mb-2 pt-2 border-top align-items-start">
                        <div className="rounded-circle text-white d-flex justify-content-center align-items-center me-2 flex-shrink-0" style={{ width: "20px", height: "20px", backgroundColor: "#1d4ed8", fontSize: "11px", fontWeight: "bold", marginTop: "2px" }}>2</div>
                        <div className="flex-grow-1 pe-1">
                          <h6 className="fw-bold mb-1 text-body-emphasis" style={{ fontSize: "13px" }}>Học bổng thế nào?</h6>
                          <p className="text-body-secondary mb-0 text-truncate" style={{ fontSize: "11.5px", lineHeight: "1.3", maxWidth: "180px" }}>HTO hỗ trợ săn học bổng từ các trường...</p>
                        </div>
                        <img src="./assets/images/hito_6.png" width="32" height="32" alt="HITO" className="rounded-circle flex-shrink-0 bg-secondary-subtle" style={{ objectFit: "cover" }} />
                      </div>
                      ...
                      {/* Q3 */}
                      <div className="d-flex mb-2 pt-2 border-top align-items-start">
                        <div className="rounded-circle text-white d-flex justify-content-center align-items-center me-2 flex-shrink-0" style={{ width: "20px", height: "20px", backgroundColor: "#1d4ed8", fontSize: "11px", fontWeight: "bold", marginTop: "2px" }}>3</div>
                        <div className="flex-grow-1 pe-1">
                          <h6 className="fw-bold mb-1 text-body-emphasis" style={{ fontSize: "13px" }}>Tài chính bao nhiêu?</h6>
                          <p className="text-body-secondary mb-0 text-truncate" style={{ fontSize: "11.5px", lineHeight: "1.3", maxWidth: "180px" }}>Tối thiểu 11.904 EUR/năm (quy định 2026).</p>
                        </div>
                        <img src="./assets/images/hito_6.png" width="32" height="32" alt="HITO" className="rounded-circle flex-shrink-0 bg-secondary-subtle" style={{ objectFit: "cover" }} />
                      </div>
                    </div>
                    
                    <div className="d-flex flex-column flex-xl-row justify-content-between align-items-center pt-2 mt-1 border-top gap-2">
                      <a href="#" className="text-decoration-none fw-bold text-primary d-flex align-items-center" style={{ fontSize: "13px" }}>
                        Xem tất cả <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="ms-1"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
                      </a>
      ...
      {/* TRẢ LẠI FOOTER VÀO ĐÚNG VỊ TRÍ GỐC CHUẨN */}
      <Footer />
    </div>
  );
}
